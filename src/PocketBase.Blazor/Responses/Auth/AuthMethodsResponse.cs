namespace PocketBase.Blazor.Responses.Auth
{
    ...
    {
        public PasswordResponse Password { get; init; } = new();
        public Oauth2Response Oauth2 { get; init; } = new();
        public MfaResponse Mfa { get; init; } = new();
        public OtpResponse Otp { get; init; } = new();
    }
