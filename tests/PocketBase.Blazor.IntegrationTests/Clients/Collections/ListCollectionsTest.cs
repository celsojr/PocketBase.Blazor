...
public class ListCollectionsTest
{
    ...
    {
        Result<ListResult<CollectionModel>> result = await _pb
            .Collections
    ...
    {
        // Test first page
        Result<ListResult<CollectionModel>> result = await _pb.Collections
    ...
    {
        Result<ListResult<CollectionModel>> result1 = await _pb.Collections
            .GetListAsync<CollectionModel>(perPage: 1);

        Result<ListResult<CollectionModel>> result5 = await _pb.Collections
    ...
    public async Task List_collections_with_name_filter()
    {
        ...
        Result<ListResult<CollectionModel>> allCollections = await _pb.Collections
            .GetListAsync<CollectionModel>();

        CollectionModel knownCollection = allCollections.Value.Items.First();
    ...
    public async Task List_collections_sorted_by_created_date_descending()
    {
        ...
        List<DateTime?> createdDates = result.Value.Items.Select(c => c.Created).ToList();
        List<DateTime?> sortedDates = createdDates.OrderByDescending(d => d).ToList();
    ...
    public async Task List_collections_can_return_different_model_type()
    {
        ...
        Result<ListResult<MinimalCollectionModel>> result = await _pb.Collections
